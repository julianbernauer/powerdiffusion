...
# setwd("//nas-sowi.campus.unibe.ch/sowi/homes/ipw/jbernauer/Democracy and Power Diffusion/Data")

# replication July 2018 
setwd("E:/DPD CUP 2018/revision 2018/Doku2018/dataverse_files_chapter3")

# 2018 reduced data set 
...
######################################
#Figure 3.6: measurement model results  
